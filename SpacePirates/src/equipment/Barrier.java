...
/**
 * Barrier class is a subclass of Equipment
 */
public class Barrier extends Equipment {

	/**
	 * Constructor passes the name of itself, health bar level, and price to
	 * superclass constructor. A newly constructed barrier's health bar starts
	...
	public Barrier(int level) {
		super("Barrier", healthBarLevel(level), healthBarLevel(level), 250);
	}
	 ...
	 * constructed barrier's health bar for a level one ship starts at the
	 * maximum level of 100. The price of all equipment is $250
	 */
	public Barrier() {
		super("Barrier", healthBarLevel(1), healthBarLevel(1), 250);
	}

	/**
	 * healthBarLevel method determines the max level of health of the barrier.
